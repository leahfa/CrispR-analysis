### score comparison, colon- and comma-combining, add sequence column
##  VERSION 4: use more BLAST info to determine which DNA strand, and TRUE start position. loop order swapped. remove short segments of total spacer
#

#install.packages("stringr")	#download stringr package for counting
